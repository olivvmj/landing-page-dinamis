...
<section class="section dashboard">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title" style="margin-bottom: 0px;">Solusi Parkirkan</h5>
                    <div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="solusi" class="form-control" name="solusi" value="{{ old('solusi') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="desk_solusi" class="form-control" name="desk_solusi" value="{{ old('desk_solusi') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function submit() {
        ...
        console.log("Solusi Aplikasi:", solusi);
        console.log("Deskripsi Solusi Aplikasi:", desk_solusi);

        var formData = new FormData(form);
        formData.append('judul', judul);
        formData.append('subjudul', subjudul);
        formData.append('solusi', solusi);
        formData.append('desk_solusi', desk_solusi);
        ...
        if (submit_method === 'create') {
            url = "{{ route('kelola-solusi.store') }}";
        } else if (submit_method === 'edit') {
            url = "{{ route('kelola-solusi.update', ':id') }}";
            url = url.replace(':id', id);
